        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
               {{--  <a href="index" class="logo logo-dark">
                ...
                <a href="{{url('appointment_book') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset ('/assets/images/logo-white.png') }}" alt="" height="40">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset ('/assets/images/logo-white.png') }}" alt="" height="40">
                    </span>
            ...
            <div class="logo_menu_margin"></div>
            ...
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('client.index') }}'" type="button"
                        class="btn {{ str_contains(url()->current(), '/client') ? 'selected_btn' : '' }} header-item noti-icon top_nav_btns waves-effect">
                    <i class="fas fa-users menu_item_icon"></i>
                    <br>
                    <span>Clients</span>
                </button>
            </div>
            ...
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('employee.index') }}'" type="button"
                        class="btn {{ str_contains(url()->current(), '/employee') ? 'selected_btn' : '' }} header-item noti-icon top_nav_btns waves-effect">
                    <i class="fas fa-user menu_item_icon"></i>
                    <br>
                    <span>Employees</span>
                </button>
            ...
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('service.index') }}'" type="button"
                        class="btn {{ str_contains(url()->current(), '/service') ? 'selected_btn' : '' }} header-item noti-icon top_nav_btns waves-effect">
                    <i class="fas fa-wrench menu_item_icon"></i>
                    <br>
                    <span>Services</span>
                </button>
            </div>
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('product.index') }}'" type="button"
                        class="btn {{ str_contains(url()->current(), '/product') ? 'selected_btn' : '' }} header-item noti-icon top_nav_btns waves-effect">
                    <i class="fas fa-shopping-bag menu_item_icon"></i>
                    <br>
                    <span>Products</span>
                </button>
            </div>
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('package.index') }}'" type="button"
                    ...
                    <i class="fas fa-shopping-basket menu_item_icon"></i>
                    <br>
                    <span>Packages</span>
                </button>
            </div>
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('cash_drawer.index') }}'" type="button"
                        class="btn {{ str_contains(url()->current(), '/cash_drawer') ? 'selected_btn' : '' }} header-item noti-icon top_nav_btns waves-effect">
            ...
            <div class="dropdown d-none d-lg-inline-block ml-1">
                <button onclick="location.href='{{ route('schedule.index') }}'" type="button"
