...
<div class="client-tabs-wrapper mt-2">
    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#personal_info" role="tab"
               aria-selected="false">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#loyalty_points" role="tab"
               aria-selected="false">
                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                <span class="d-none d-sm-block">Loyalty Points</span>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#photos" role="tab"
               aria-selected="false">
                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                <span class="d-none d-sm-block">Photos</span>
            </a>
        </li>
    </ul>
</div>
